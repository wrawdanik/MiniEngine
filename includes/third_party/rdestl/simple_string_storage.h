...
public:
	...
	simple_string_storage(simple_string_storage&& other, const allocator_type& allocator)
			: m_allocator(allocator)
	{
		this->m_data=other.m_data;
		this->m_end_of_data=other.m_end_of_data;
	...
	simple_string_storage& operator=(simple_string_storage&& other)
	{
		if (this!=&other)
		{
			this->m_data=other.m_data;
