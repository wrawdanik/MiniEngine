...
public:
	...
	vector(vector&& other, const allocator_type& allocator = allocator_type()):	TStorage(allocator)
	{
		TStorage::m_begin=other.m_begin;
		TStorage::m_end=other.m_end;
		TStorage::m_capacityEnd=other.m_capacityEnd;
